...
class ChatbotApp(ctk.CTk):
    ...
    def setup_ui(self):
        ...
        self.clear_button.grid(row=6, column=0, padx=15, pady=5, sticky="ew")
        ...
        self.history_label.grid(row=7, column=0, pady=(10,0))
        ...
        self.history_frame.grid(row=8, column=0, padx=10, sticky="ew")
    ...
    def _start_fresh_chat(self):
        ...
        self.current_session.history.append({'role': 'system', 'content': SYSTEM_PROMPT})
        ...
        self.append_message(self.current_session, "Chatbot", "Hey there! 👋 I'm your AI Fitness Coach.")
        self.append_message(self.current_session, "Chatbot", "Ask me for workout plans, diet tips, or goal strategies — I'm here to help you get stronger, leaner, and healthier. Let's crush it together! 💪")
    ...
    def send_message(self, session):
        ...
        self.append_message(session, "Chatbot", " ")
    ...
    def load_chat(self, filename):
        ...
        try:
            ...
            self.show_toast(f"Load failed: {e}")
    ...
    def load_chat_buttons(self):
        ...
        for f in files[:12]:
            btn = ctk.CTkButton(
                ...
                text=f.replace(".json",""),
                height=28,
                command=lambda file=f: self.load_chat(file)
            )
    ...
    def load_settings(self):
        ...
        if os.path.exists(SETTINGS_FILE):
            with open(SETTINGS_FILE) as f:
                current_theme = json.load(f).get("theme", "dark")
